...
измени код таким образом, чтобы он динамически выводил в терминал количество FPS. Запрещено использовать другие библиотеки, кроме того, что используется в коде сейчас
